...
func padingCell(text: string; cell:CELL;) :string =
  var i: Natural = 0
...
func calculPosCell(this: GRIDSFL) =
...
proc ioGrid*(this: GRIDSFL ): (Key , seq[string])=        # IO Format
  var buf :seq[string]
