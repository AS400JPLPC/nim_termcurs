...
let jsonObject = %* {"titleTerm": "DESIGNER"}
echo $jsonObject
...
proc dscTEST() =
  ...
  for n in 0..len(jsonPanel["panel"]["button"])-1:
    var bton = toButton(jsonPanel["panel"]["button"][n]["Tkey"].getStr() ,
                        jsonPanel["panel"]["button"][n]["txtKey"].getStr() , jsonPanel["panel"]["button"][0]["actif"].getBool())
    buttonVal.add(@[bton])


  TEST = newPanel( jsonPanel["panel"]["name"].getStr(),
                  jsonPanel["panel"]["posx"].getInt(),
                  jsonPanel["panel"]["posy"].getInt(),
                  jsonPanel["panel"]["height"].getInt(),
                  jsonPanel["panel"]["width"].getInt(),
                  @buttonVal,toCadre(jsonPanel["panel"]["cadre"].getStr()),jsonPanel["panel"]["title"].getStr())


  beug(370,"Panel")

# LABEL  -> TEST
  for n in 0..len(jsonPanel["panel"]["label"])-1:
    if jsonPanel["panel"]["label"][n]["defLabel"].getStr() == "Title" :
      TEST.label.add(defTitle(jsonPanel["panel"]["label"][n]["name"].getStr() ,
                      jsonPanel["panel"]["label"][n]["posx"].getInt() ,
                      jsonPanel["panel"]["label"][n]["posy"].getInt() ,
                      jsonPanel["panel"]["label"][n]["text"].getStr()))
    else :
      TEST.label.add(defLabel(jsonPanel["panel"]["label"][n]["name"].getStr() ,
                      jsonPanel["panel"]["label"][n]["posx"].getInt() ,
                      jsonPanel["panel"]["label"][n]["posy"].getInt() ,
                      jsonPanel["panel"]["label"][n]["text"].getStr()))
    beug(384,jsonPanel["panel"]["label"][n]["name"].getStr())

  # FIELD -> TEST
  for n in 0..len(jsonPanel["panel"]["field"])-1:
    beug(388,jsonPanel["panel"]["field"][n]["name"].getStr())
    echo toRefType(jsonPanel["panel"]["field"][n]["reftype"].getStr())


    case jsonPanel["panel"]["field"][n]["defFld"].getStr() :

      of "defString" :
            TEST.field.add(defString(jsonPanel["panel"]["field"][n]["name"].getStr() ,
                      jsonPanel["panel"]["field"][n]["posx"].getInt() ,
                      jsonPanel["panel"]["field"][n]["posy"].getInt() ,
                      toRefType(jsonPanel["panel"]["field"][n]["reftype"].getStr()),
                      jsonPanel["panel"]["field"][n]["width"].getInt() ,
                      jsonPanel["panel"]["field"][n]["text"].getStr() ,
                      jsonPanel["panel"]["field"][n]["empty"].getBool(),
                      jsonPanel["panel"]["field"][n]["errmsg"].getStr() ,
                      jsonPanel["panel"]["field"][n]["help"].getStr()
                      ))

      of "defMail" :
            TEST.field.add(defMail(jsonPanel["panel"]["field"][n]["name"].getStr() ,
                      jsonPanel["panel"]["field"][n]["posx"].getInt() ,
                      jsonPanel["panel"]["field"][n]["posy"].getInt() ,
                      toRefType(jsonPanel["panel"]["field"][n]["reftype"].getStr()),
                      jsonPanel["panel"]["field"][n]["width"].getInt() ,
      ...
      of "defSwitch" :
            TEST.field.add(defSwitch(jsonPanel["panel"]["field"][n]["name"].getStr() ,
                      jsonPanel["panel"]["field"][n]["posx"].getInt() ,
                      jsonPanel["panel"]["field"][n]["posy"].getInt() ,
                      toRefType(jsonPanel["panel"]["field"][n]["reftype"].getStr()),
                      jsonPanel["panel"]["field"][n]["switch"].getBool(),
                      jsonPanel["panel"]["field"][n]["empty"].getBool(),
                      jsonPanel["panel"]["field"][n]["errmsg"].getStr() ,
                      jsonPanel["panel"]["field"][n]["help"].getStr()
                      ))
      ...
      of "defDate" :
            TEST.field.add(defDate(jsonPanel["panel"]["field"][n]["name"].getStr() ,
                      jsonPanel["panel"]["field"][n]["posx"].getInt() ,
                      jsonPanel["panel"]["field"][n]["posy"].getInt() ,
                      toRefType(jsonPanel["panel"]["field"][n]["reftype"].getStr()),
                      jsonPanel["panel"]["field"][n]["text"].getStr() ,
      ...
      of "defNumeric" :
            TEST.field.add(defNumeric(jsonPanel["panel"]["field"][n]["name"].getStr() ,
                      jsonPanel["panel"]["field"][n]["posx"].getInt() ,
                      jsonPanel["panel"]["field"][n]["posy"].getInt() ,
                      toRefType(jsonPanel["panel"]["field"][n]["reftype"].getStr()),
                      jsonPanel["panel"]["field"][n]["width"].getInt() ,
                      jsonPanel["panel"]["field"][n]["scal"].getInt() ,
                      jsonPanel["panel"]["field"][n]["text"].getStr() ,
                      jsonPanel["panel"]["field"][n]["empty"].getBool(),
                      jsonPanel["panel"]["field"][n]["errmsg"].getStr() ,
                      jsonPanel["panel"]["field"][n]["help"].getStr()
      ...
      of "defTelephone" :
            TEST.field.add(defTelephone(jsonPanel["panel"]["field"][n]["name"].getStr() ,
                      jsonPanel["panel"]["field"][n]["posx"].getInt() ,
                      jsonPanel["panel"]["field"][n]["posy"].getInt() ,
                      toRefType(jsonPanel["panel"]["field"][n]["reftype"].getStr()),
                      jsonPanel["panel"]["field"][n]["width"].getInt() ,
    ...
    if jsonPanel["panel"]["field"][n]["EdtCar"].getStr() != "" :
      setEdtCar(TEST.field[getIndex(TEST,jsonPanel["panel"]["field"][n]["name"].getStr())],
                jsonPanel["panel"]["field"][n]["EdtCar"].getStr())

    if jsonPanel["panel"]["field"][n]["Protect"].getbool() == true :
      setProtect(TEST.field[getIndex(TEST,jsonPanel["panel"]["field"][n]["name"].getStr())],true)

    if jsonPanel["panel"]["field"][n]["Process"].getStr() != "" :
      setProcess(TEST.field[getIndex(TEST,jsonPanel["panel"]["field"][n]["name"].getStr())],
      jsonPanel["panel"]["field"][n]["Process"].getStr() )
...
# MENU -> TEST
var MH00 = new(MENU)
if hasKey(jsonPanel["panel"], "field") == true:
